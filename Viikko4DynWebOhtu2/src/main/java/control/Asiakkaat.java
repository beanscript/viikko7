...
public class Asiakkaat extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String pathInfo = request.getPathInfo(); // haetaan kutsun polkutiedot, esim. /Maija
		...
		if (pathInfo == null) { // Haetaan kaikki asiakkaat
			...
			String asiakas_id = pathInfo.replace("/haeyksi/", ""); // poistetaan polusta "/haeyksi/", j‰ljelle j‰‰
																	// asiakas_id
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response)
		...
		JSONObject jsonObj = new JsonStrToObj().convert(request); // Muutetaan kutsun mukana tuleva json-string
																	// json-objektiksi
		String vanhaid = jsonObj.getString("vanhaid");
		Asiakas asiakas = new Asiakas();
		asiakas.setAsiakas_id(jsonObj.getInt("asiakas_id"));
		asiakas.setEtunimi(jsonObj.getString("etunimi"));
		asiakas.setSukunimi(jsonObj.getString("sukunimi"));
